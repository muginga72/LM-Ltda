 ...
 * Only Laurindo Muginga or ADMIN_EMAIL can access
 */
const adminOnly = (req, res, next) => {
  if (
    req.user &&
    req.user.role === 'admin' &&
    (req.user.fullName === 'Laurindo Muginga' ||
...
/**
 * Lightweight authenticate middleware (alias of protect)
 * Useful if you want a simpler naming convention
 */
