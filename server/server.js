...
// // Allow cross-origin image use in dev: set CORP to cross-origin and allow the client origin
// app.use('/uploads', (req, res, next) => {
//   res.setHeader('Access-Control-Allow-Origin', process.env.CLIENT_ORIGIN || 'http://localhost:3000');
//   // allow cross-origin usage of images (avoids ERR_BLOCKED_BY_RESPONSE.NotSameOrigin)
//   res.setHeader('Cross-Origin-Resource-Policy', 'cross-origin');
//   next();
// });

// // Serve uploads as static files (mount early)
...
// // 404 fallback (after static and API routes)
// app.use((req, res, next) => {
